...
type PublicKey_Bn254 struct {
	Bn254 []byte `protobuf:"bytes,99,opt,name=bn254,proto3,oneof" json:"bn254,omitempty"`
}

func (*PublicKey_Ed25519) isPublicKey_Sum()   {}
func (*PublicKey_Secp256K1) isPublicKey_Sum() {}
func (*PublicKey_Bls12381) isPublicKey_Sum()  {}
func (*PublicKey_Bn254) isPublicKey_Sum()     {}
...
func (m *PublicKey) GetBn254() []byte {
	if x, ok := m.GetSum().(*PublicKey_Bn254); ok {
		return x.Bn254
	}
	return nil
}
...
var fileDescriptor_25c5fd298152e170 = []byte{
	...
	,
}
...
func (this *PublicKey_Bn254) Compare(that interface{}) int {
	if that == nil {
		if this == nil {
			return 0
		}
	...
	that1, ok := that.(*PublicKey_Bn254)
	if !ok {
		that2, ok := that.(PublicKey_Bn254)
		if ok {
			that1 = &that2
		} else {
			return 1
	...
	if c := bytes.Compare(this.Bn254, that1.Bn254); c != 0 {
		return c
	}
	return 0
}
...
func (this *PublicKey_Bn254) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
	...
	if !bytes.Equal(this.Bn254, that1.Bn254) {
		return false
	}
	return true
}
...
func (m *PublicKey_Bn254) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PublicKey_Bn254) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Bn254 != nil {
		i -= len(m.Bn254)
		copy(dAtA[i:], m.Bn254)
		i = encodeVarintKeys(dAtA, i, uint64(len(m.Bn254)))
		i--
		dAtA[i] = 0x6
		i--
		dAtA[i] = 0x9a
...
func (m *PublicKey_Bn254) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PublicKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 99:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Bn254", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
