...
type CanonicalVoteNoTimestamp struct {
	Type    SignedMsgType     `protobuf:"varint,1,opt,name=type,proto3,enum=cometbft.types.v1.SignedMsgType" json:"type,omitempty"`
	Height  int64             `protobuf:"fixed64,2,opt,name=height,proto3" json:"height,omitempty"`
	Round   int64             `protobuf:"fixed64,3,opt,name=round,proto3" json:"round,omitempty"`
	BlockID *CanonicalBlockID `protobuf:"bytes,4,opt,name=block_id,json=blockId,proto3" json:"block_id,omitempty"`
...
func (m *CanonicalVoteNoTimestamp) Reset()         { *m = CanonicalVoteNoTimestamp{} }
func (m *CanonicalVoteNoTimestamp) String() string { return proto.CompactTextString(m) }
func (*CanonicalVoteNoTimestamp) ProtoMessage()    {}
func (*CanonicalVoteNoTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd60568638662265, []int{4}
}
func (m *CanonicalVoteNoTimestamp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CanonicalVoteNoTimestamp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CanonicalVoteNoTimestamp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CanonicalVoteNoTimestamp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CanonicalVoteNoTimestamp.Merge(m, src)
}
func (m *CanonicalVoteNoTimestamp) XXX_Size() int {
	return m.Size()
}
func (m *CanonicalVoteNoTimestamp) XXX_DiscardUnknown() {
	xxx_messageInfo_CanonicalVoteNoTimestamp.DiscardUnknown(m)
}

var xxx_messageInfo_CanonicalVoteNoTimestamp proto.InternalMessageInfo

func (m *CanonicalVoteNoTimestamp) GetType() SignedMsgType {
	if m != nil {
		return m.Type
	}
	return UnknownType
...
func (m *CanonicalVoteNoTimestamp) GetHeight() int64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *CanonicalVoteNoTimestamp) GetRound() int64 {
	if m != nil {
		return m.Round
	}
	return 0
...
func (m *CanonicalVoteNoTimestamp) GetBlockID() *CanonicalBlockID {
	if m != nil {
		return m.BlockID
	}
	return nil
...
func (m *CanonicalVoteNoTimestamp) GetChainID() string {
	if m != nil {
		return m.ChainID
	}
	return ""
...
func (*CanonicalVoteExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd60568638662265, []int{5}
}
...
func init() {
	...
	proto.RegisterType((*CanonicalVoteNoTimestamp)(nil), "cometbft.types.v1.CanonicalVoteNoTimestamp")
...
var fileDescriptor_bd60568638662265 = []byte{
	...
	,
}
...
func (m *CanonicalVoteNoTimestamp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CanonicalVoteNoTimestamp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CanonicalVoteNoTimestamp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CanonicalVoteNoTimestamp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CanonicalVoteNoTimestamp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CanonicalVoteNoTimestamp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CanonicalVoteNoTimestamp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
