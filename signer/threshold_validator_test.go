...
func TestThresholdValidator2of3alt(test *testing.T) {
	total := uint8(3)
	threshold := uint8(2)
	...
	// An enhancement could be to have Local cosigner logic directly interface their peers.
	{
		...
		fmt.Printf("Cosigner 1 2 pub key: %v\n", cosigner1EphSecretPart2.SourceEphemeralSecretPublicKey)
		fmt.Printf("Cosigner 1 2 share part: %v\n", cosigner1EphSecretPart2.EncryptedSharePart)
		...
		fmt.Printf("Cosigner 1 3 pub key: %v\n", cosigner1EphSecretPart3.SourceEphemeralSecretPublicKey)
		fmt.Printf("Cosigner 1 3 share part: %v\n", cosigner1EphSecretPart3.EncryptedSharePart)
		...
		// fmt.Printf("Cosigner 2 3 pub key: %v\n", cosigner2EphSecretPart3.SourceEphemeralSecretPublicKey)
		// fmt.Printf("Cosigner 2 3 share part: %v\n", cosigner2EphSecretPart3.EncryptedSharePart)
		...
		fmt.Printf("Cosigner 3 2 pub key: %v\n", cosigner3EphSecretPart2.SourceEphemeralSecretPublicKey)
		fmt.Printf("Cosigner 3 2 share part: %v\n", cosigner3EphSecretPart2.EncryptedSharePart)
	}
