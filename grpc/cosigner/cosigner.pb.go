...
type Block struct {
	...
	VoteExtension []byte   `protobuf:"bytes,7,opt,name=voteExtension,proto3" json:"voteExtension,omitempty"`
}
...
func (m *Block) GetVoteExtension() []byte {
	if m != nil {
...
type SetNoncesAndSignRequest struct {
	Uuid          []byte   `protobuf:"bytes,1,opt,name=uuid,proto3" json:"uuid,omitempty"`
	Nonces        []*Nonce `protobuf:"bytes,2,rep,name=nonces,proto3" json:"nonces,omitempty"`
	VoteExtUuid   []byte   `protobuf:"bytes,3,opt,name=voteExtUuid,proto3" json:"voteExtUuid,omitempty"`
...
var fileDescriptor_b7a1f695b94b848a = []byte{
	...
	,
}
...
func (m *Block) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.VoteExtension) > 0 {
		...
		i = encodeVarintCosigner(dAtA, i, uint64(len(m.VoteExtension)))
		i--
		dAtA[i] = 0x3a
	}
	if m.Timestamp != 0 {
